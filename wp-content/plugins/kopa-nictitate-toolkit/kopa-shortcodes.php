...
//             if (comments_open()) {
//                 if ($num_comments == 0) {
//                     $comments = __('0 Comments', 'kopa-nictitate-toolkit');
//                 } elseif ($num_comments > 1) {
//                     $comments = $num_comments . __(' Comments', 'kopa-nictitate-toolkit');
//                 } else {
//                     $comments = __('1 Comment', 'kopa-nictitate-toolkit');
//                 }
//                $out .=  $comments;
//             } else {
//                 $out .=  __('Comments off', 'kopa-nictitate-toolkit');
//             }
//             $out .= '</span>';
//             $out .= '</div>';
//             $out .= '</article>';
